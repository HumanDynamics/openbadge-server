    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('beacon_id', models.PositiveSmallIntegerField(default=0, unique=True, validators=[django.core.validators.MaxValueValidator(32000), django.core.validators.MinValueValidator(16000)])),
                ('observed_id', models.PositiveSmallIntegerField(default=0)),
                ('active', models.BooleanField(default=True)),
                ('comments', models.CharField(default=b'Add comments', max_length=240, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=64)),
                ('badge', models.CharField(unique=True, max_length=64)),
                ('member_id', models.PositiveSmallIntegerField(default=0, unique=True, validators=[django.core.validators.MaxValueValidator(15999), django.core.validators.MinValueValidator(1)])),
                ('observed_id', models.PositiveSmallIntegerField(default=0)),
                ('active', models.BooleanField(default=True)),
                ('comments', models.CharField(default=b'Add comments', max_length=240, blank=True)),
